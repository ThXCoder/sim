...
DroneExperiment::CreateNSatellite(int NbrSatellite, double TxPower, double StartTime)
{
    ...
    for (int i = 0; i < NbrSatellite; i++)
    {
        ...
        std::cout << "Satellite " << i << " position : x = " << SatellitePosition[i % 32].x
                  << std::endl;
        std::cout << "Satellite " << i << " position : x = " << SatellitePosition[i % 32].y
                  << std::endl;
        std::cout << "Satellite " << i << " position : x = " << SatellitePosition[i % 32].z
                  << std::endl;
